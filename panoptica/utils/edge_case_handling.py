...
class EdgeCaseHandler:
    def __init__(
        ...
        self.__listmetric_zeroTP_handling: dict[ListMetric, MetricZeroTPEdgeCaseHandling] = listmetric_zeroTP_handling
        self.__empty_list_std = empty_list_std

    def handle_zero_tp(self, metric: ListMetric, tp: int, num_pred_instances: int, num_ref_instances: int) -> tuple[bool, float | None]:
        ...
        return self.__listmetric_zeroTP_handling[metric](tp=tp, num_pred_instances=num_pred_instances, num_ref_instances=num_ref_instances)
...
if __name__ == "__main__":
    ...
    r = handler.handle_zero_tp(ListMetric.IOU, tp=0, num_pred_instances=1, num_ref_instances=1)
    print(r)
